...
<a name="v4.0.26"></a>
## [4.0.27](https://github.com/d3xter666/ui5-tooling/compare/cli-v4.0.26...cli-v4.0.27) (2025-10-26)
...
* The following workspace dependencies were updated
  * dependencies
    * @ui5/builder bumped from ^4.0.11 to ^4.1.1
    * @ui5/fs bumped from ^4.0.2 to ^4.0.6
    * @ui5/logger bumped from ^4.0.2 to ^4.3.0
    * @ui5/project bumped from ^4.0.6 to ^4.0.9
    * @ui5/server bumped from ^4.0.7 to ^4.0.9
